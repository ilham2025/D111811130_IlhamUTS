...
use App\D111811130_news;
use Illuminate\Support\Facades\Validator;

class D111811130_newsController extends Controller
{
    public function index ()
    {
        // get data from table news
        $news = D111811130_news::latest()->get();
    ...
    {
        // find news bi id
        $new = D111811130_news::findOrfail($id);
    ...
    public function update (Request $request, news $new)
    {
        ...
        // find news by id 
        $new = D111811130_news::findOrfail($new->$id);
        if ($new){
